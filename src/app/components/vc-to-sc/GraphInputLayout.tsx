export default function GraphInputLayout({ edges, toggleEdge }) {
    ...
    let layouts = [
        <svg width="297.6" height="284.8" viewBox="0 0 372 356" fill="none">
            <line id="line00" x1="20.6264" y1="172.577" x2="102.626" y2="24.5768" onClick={() => handleClick(0)} stroke={edges[0]} strokeWidth="10"/>
            <line id="line01" x1="265.063" y1="29.9996" x2="107.063" y2="31.9996" onClick={() => handleClick(1)} stroke={edges[1]} strokeWidth="10"/>
            <line id="line02" x1="260.57" y1="331.318" x2="102.57" y2="29.3179" onClick={() => handleClick(2)} stroke={edges[2]} strokeWidth="10"/>
            <line id="line03" x1="102" y1="329" x2="102" y2="27" onClick={() => handleClick(3)} stroke={edges[3]} strokeWidth="10"/>
            <line id="line04" x1="344.376" y1="179.256" x2="104.376" y2="31.2559" onClick={() => handleClick(4)} stroke={edges[4]} strokeWidth="10"/>
            <line id="line05" x1="22.35" y1="172.76" x2="262.35" y2="22.76" onClick={() => handleClick(5)} stroke={edges[5]} strokeWidth="10"/>
            <line id="line06" x1="102.57" y1="326.682" x2="260.57" y2="24.6822" onClick={() => handleClick(6)} stroke={edges[6]} strokeWidth="10"/>
            <line id="line07" x1="260" y1="329" x2="260" y2="27" onClick={() => handleClick(7)} stroke={edges[7]} strokeWidth="10"/>
            <line id="line08" x1="342.626" y1="177.423" x2="260.626" y2="29.4232" onClick={() => handleClick(8)} stroke={edges[8]} strokeWidth="10"/>
            <line id="line09" x1="25" y1="172" x2="347" y2="172" onClick={() => handleClick(9)} stroke={edges[9]} strokeWidth="10"/>
